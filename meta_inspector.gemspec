require File.expand_path('lib/meta_inspector/version', __dir__)

Gem::Specification.new do |gem|
  gem.authors       = ['Jaime Iniesta']
  gem.email         = ['jaimeiniesta@gmail.com']
  gem.description   = 'MetaInspector lets you scrape a web page and get its links, images, texts, meta tags...'
  gem.summary       = 'MetaInspector is a ruby gem for web scraping purposes, that returns metadata from a given URL'
  ...
  gem.add_dependency 'fastimage', '~> 2.2.7'
